...
print(
    f"Unemployment Population difference between August to September is {diffPop} thousand less"
)
...
print(
    f"The unemployment populaton might be {var1} thousand in September 2020, which is a {var2} month-to-month change rate."
)
